...
const Home = () => {
  ...
  return <div className="HomeBgd">
    ...
    <img className="homeImg" src={process.env.PUBLIC_URL + "/img/ajd.png"} style={{ width: "400px", height: "650px" }} />
    <div className="Home">
      ...
      <button onClick={downloadAppFile} className='downbtn' style={{ fontSize: "30px" }}>멍멍케어 다운로드</button>
    </div>
    <img className="homeImg2" src={process.env.PUBLIC_URL + "/img/44.png"} style={{ width: "400px", height: "550px" }} />
  </div>
}
